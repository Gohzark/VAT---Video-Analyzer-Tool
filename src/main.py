...
import os
import argparse
from analyst.analystFourier import AnalystFourier
from analyst.analystStartStop import AnalystStartStop
import algorithm.optical_flow_dense as optical_flow_dense
import algorithm.optical_flow_sparse as optical_flow_sparse

from enums import Algorithm, Mask, Tracker
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Video Analyst Tool')
